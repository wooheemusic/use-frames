import { STIFFNESS, MASS, DAMPING } from '../variables';
...
export default function getHarmonic({ damping: c = DAMPING, stiffness: k = STIFFNESS, mass: m = MASS, d: d0 = 1, v: v0 = 0, halfPeriods: hp = 0 } ={}) {
